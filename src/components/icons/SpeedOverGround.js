...
function SpeedOverGround(props) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        stroke="#000"
        strokeWidth="30"
        d="M32.039 356.574C58.78 483.231 170.551 573.868 300 573.868s241.22-90.637 267.961-217.294H32.039z"
      />
      <text
        textAnchor={"middle"}
        x="300"
        ...
        fontSize="139.605"
      >
        {props.speedOverWater ? props.speedOverWater.toFixed(2) : null}
      </text>
    </svg>
  );
}

export default SpeedOverGround;
